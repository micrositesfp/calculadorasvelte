...
var app = (function () {
    ...
    /* src\components\Botao.svelte generated by Svelte v3.57.0 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*texto*/ ctx[0]);
    			attr_dev(button, "class", "botao svelte-1konl9n");
    			...
    			add_location(button, file$4, 12, 0, 281);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", click, false, false, false, false);
    				mounted = true;
    			}
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Botao> was created with unknown prop '${key}'`);
    	});
    ...
    /* src\components\Linha.svelte generated by Svelte v3.57.0 */
    ...
    /* src\components\Tela.svelte generated by Svelte v3.57.0 */
    ...
    /* src\components\Calculadora.svelte generated by Svelte v3.57.0 */
    ...
    function create_default_slot_3(ctx) {
    	...
    	let botao3;
    	let current;
    	botao0 = new Botao({ props: { texto: "9" }, $$inline: true });
    	botao1 = new Botao({ props: { texto: "8" }, $$inline: true });
    	botao2 = new Botao({ props: { texto: "7" }, $$inline: true });
    ...
    function create_default_slot_2(ctx) {
    	...
    	let botao3;
    	let current;
    	botao0 = new Botao({ props: { texto: "6" }, $$inline: true });
    	botao1 = new Botao({ props: { texto: "5" }, $$inline: true });
    	botao2 = new Botao({ props: { texto: "4" }, $$inline: true });
    ...
    function create_default_slot_1(ctx) {
    	...
    	let botao3;
    	let current;
    	botao0 = new Botao({ props: { texto: "3" }, $$inline: true });
    	botao1 = new Botao({ props: { texto: "2" }, $$inline: true });
    	botao2 = new Botao({ props: { texto: "1" }, $$inline: true });
    ...
    function create_fragment$1(ctx) {
    	...
    	tela = new Tela({
    			props: { valor: '111111111111111111012345678910' },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "calculadora svelte-1srsvd3");
    			add_location(div, file$1, 5, 4, 148);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Botao, Linha, Tela });
    	return [];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-17m4lxg");
